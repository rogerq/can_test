...
ifconfig $CANDEV up 
sleep 1
VAL=$(devmem2 0x481CC000 | awk '/Read at address/{print $6}')
...
sleep 1
VAL=$(devmem2 0x44DF8C28 | awk '/Read at address/{print $6}')
...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
echo "Boots: $ITERS, UP fails: $UP_FAIL, OFF fails: $OFF_FAIL, READ fails: $READ_FAIL"
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
